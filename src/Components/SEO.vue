        ...
        <div class="flex flex-col space-y-5">
            <div class="flex flex-row items-center mt-5 space-x-5">
                <div class="flex flex-col space-y-1">
                    <span class="flex flex-row items-center text-[#525252] text-[15px] font-[400] leading-[26px]">SEO Score</span>
                ...
                <div class="flex flex-col space-y-1">
                    <span class="flex flex-row items-center text-[#525252] text-[15px] font-[400] leading-[26px]">Keyword Density</span>
                    <select class="bg-[#fff] border-[#CBCBCB] border-[1px] py-3 px-4 rounded-md w-full sm:w-[250px]">
                        <option selected>Choose</option>
                ...
                <div class="flex flex-col space-y-1">
                    <span class="flex flex-row items-center text-[#525252] text-[15px] font-[400] leading-[26px]">Tags</span>
                    <select class="bg-[#fff] border-[#CBCBCB] border-[1px] py-3 px-4 rounded-md w-full sm:w-[250px]">
                        <option selected>Choose</option>
